...
namespace Silkier.AspNetCore
{
    public static class HealthChecksExtension
    {
        ...
        public static IHealthChecksBuilder AddNTPDateTimeHealthCheck(this IHealthChecksBuilder builder, string ntpserver, double toleratesec = 10, string name = "NTPDateTime")
        {
